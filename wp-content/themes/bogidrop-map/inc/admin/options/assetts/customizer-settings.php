        ...
        ******************************************************************/
            if ( apply_filters( 'igthemes_customizer_more', true ) ) {
                ...
                $wp_customize->add_section( 'upgrade_premium' , array(
                    'title'      		=> __( 'Want More? Get Premium', 'bogidope' ),
                    'panel'             => '',
                    'priority'   		=> 1,
                ) );
                ...
                $wp_customize->add_control( new IGthemes_More_Control( $wp_customize, 'upgrade_premium', array(
                    'label'    			=> __( 'Looking for more options?', 'bogidope' ),
...
//home_heading
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'home_heading', array(
         ...
         'label' => __( 'Posts', 'bogidope' ),
         'description' => __( '', 'bogidope' ),
...
//home_posts_per_page
    ...
    $wp_customize->add_control('home_posts_per_page', array(
        'label' => __('', 'bogidope'),
        'description' => __('Change the number of posts showed in the home page.', 'bogidope'),
        'type' => 'number',
        'section' => 'home-settings',
...
//home_portfolio_heading
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'home_portfolio_heading', array(
         'section' => 'home-settings',
         'label' => __( 'Portfolio section', 'bogidope' ),
         'description' => __( 'To use this section you must download and install our free <a href="https://wordpress.org/plugins/ig-portfolio/" target="_blank">IG Portfolio</a> plugin.', 'bogidope' ),
         'active_callback' => 'is_home',
    ) ) );
//home_portfolio
    ...
    $wp_customize->add_control('home_portfolio', array(
        'label' => __('Enable portfolio section?', 'bogidope'),
        'description' => __('', 'bogidope'),
        'type' => 'checkbox',
        'section' => 'home-settings',
...
//home_portfolio_title
    $wp_customize->add_setting('home_portfolio_title', array(
        'default' => __('Our new projects', 'bogidope'),
        'sanitize_callback' => 'igthemes_sanitize_textarea',
    ));
    $wp_customize->add_control('home_portfolio_title', array(
        'label' => __('', 'bogidope'),
        'description' => __('Section title', 'bogidope'),
        'type' => 'text',
        'section' => 'home-settings',
...
//home_portfolio_description
    $wp_customize->add_setting('home_portfolio_description', array(
        'sanitize_callback' => 'igthemes_sanitize_text',
        'default' => __('See our latest works!', 'bogidope'),
         'active_callback' => 'is_home',
    ));
    $wp_customize->add_control('home_portfolio_description', array(
        'label' => __('', 'bogidope'),
        'description' => __('Section description', 'bogidope'),
        'type' => 'textarea',
        'section' => 'home-settings',
...
//home_portfolio_tax
    ...
    $wp_customize->add_control('home_portfolio_tax', array(
        'label' => __('', 'bogidope'),
        'description' => __('Write the slug of the category you want to show', 'bogidope'),
        'type' => 'text',
        'section' => 'home-settings',
...
//home_testimonials_heading
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'home_testimonials_heading', array(
         'section' => 'home-settings',
         'label' => __( 'Testimonials section', 'bogidope' ),
         'description' => __( 'To use this section you must download and install our free <a href="https://wordpress.org/plugins/ig-testimonals/" target="_blank">IG Testimonials</a> plugin.', 'bogidope' ),
         'active_callback' => 'is_home',
    ) ) );
//home_testimonials
    ...
    $wp_customize->add_control('home_testimonials', array(
        'label' => __('Enable testimonials section?', 'bogidope'),
        'description' => __('', 'bogidope'),
        'type' => 'checkbox',
        'section' => 'home-settings',
...
//home_testimonials_title
    $wp_customize->add_setting('home_testimonials_title', array(
        'default' => __('What our clients says', 'bogidope'),
         'sanitize_callback' => 'igthemes_sanitize_textarea',
    ));
    $wp_customize->add_control('home_testimonials_title', array(
        'label' => esc_html__('', 'bogidope'),
        'description' => __('Section title', 'bogidope'),
        'type' => 'text',
        'section' => 'home-settings',
...
//home_testimonials_description
    $wp_customize->add_setting('home_testimonials_description', array(
        'sanitize_callback' => 'igthemes_sanitize_text',
        'default' => __('We make every thing with best quality, our customers and partners are very happy!', 'bogidope'),
    ));
...
//Images
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'blog-layout', array(
        'label' => esc_html__('Blog layout', 'bogidope'),
        'description' => esc_html__('', 'bogidope'),
...
//main layout
    ...
    $wp_customize->add_control(
            ...
            array(
                'label'			=> __( '', 'bogidope' ),
                'description'	=> __( 'Select the blog layout', 'bogidope' ),
                'priority' =>   2, 
                'type'          => 'radio-image',
                'section'		=> 'blog-settings',
...
//main post content
    ...
    $wp_customize->add_control('main_post_content', array(
        'label' => esc_html__('Display full posts content', 'bogidope'),
        'description' => esc_html__('', 'bogidope'),
        'type' => 'checkbox',
        'section' => 'blog-settings',
...
//Images
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'images', array(
        'label' => esc_html__('Images', 'bogidope'),
        'description' => esc_html__('', 'bogidope'),
        'section' => 'blog-settings',
        'settings' => 'images',
        'priority'   => 5,
...
//main featured images
    ...
    $wp_customize->add_control('main_featured_images', array(
        'label' => esc_html__('Display posts featured images', 'bogidope'),
        'description' => esc_html__('', 'bogidope'),
        'type' => 'checkbox',
        'section' => 'blog-settings',
...
//Navigation
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'navigation', array(
        'label' => esc_html__('Navigation', 'bogidope'),
        'description' => esc_html__('', 'bogidope'),
        'section' => 'blog-settings',
        'settings' => 'navigation',
    ) ) );
//numeric_pagination
    ...
    $wp_customize->add_control(
        'numeric_pagination',
        array(
            'label'         => esc_html__('Use numeric pagination?', 'bogidope'),
            'description'   => __( 'WP-PageNavi supported', 'bogidope'),
            'type'          => 'checkbox',
            'section'       => 'blog-settings',
...
******************************************************************/
    ...
    $wp_customize->add_control(
        'breadcrumb',
        array(
            'label'         => esc_html__('Display breadcrumb?', 'bogidope'),
            'description'   => __( 'Yoast Breadcrumb supported<br>NavXT Breadcrumb supported', 'bogidope'),
            'type'          => 'checkbox',
            'section'       => 'post-settings',
    ...
    $wp_customize->add_control( 'post_nav',
        array(
            'label'         => esc_html__('Show previous/next post links?', 'bogidope'),
            'description'   => __( '', 'bogidope'),
            'type'          => 'checkbox',
            'section'       => 'post-settings',
            'settings'      => 'post_nav',
...
//header colors
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'header_colors', array(
        'label' => esc_html__('Colors', 'bogidope'),
        'description' => esc_html__('', 'bogidope'),
...
//header color
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'header_background_color',
            array(
                'label' => __('', 'bogidope'),
                'description' => __('Background color', 'bogidope'),
                'type' => 'color',
                'section' => 'header-settings',
...
//header text color
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'header_text_color',
            array(
                'label' => __('', 'bogidope'),
                'description' => __('Text color', 'bogidope'),
                'type' => 'color',
                'section' => 'header-settings',
...
//header link normal
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'header_link_normal',
            array(
                'label' => __('', 'bogidope'),
                'description' => __('Link color', 'bogidope'),
                'type' => 'color',
                'section' => 'header-settings',
...
//header link hover
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'header_link_hover',
            array(
                'label' => __('', 'bogidope'),
                'description' => __('Link hover color', 'bogidope'),
                'type' => 'color',
                'section' => 'header-settings',
...
******************************************************************/
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'body_text_color',
            array(
                'label' => __('', 'bogidope'),
                'description' => __('Body text color', 'bogidope'),
                'priority' => 1,
                'type' => 'color',
                'section' => 'typography-settings',
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'body_headings_color',
            array(
                'label' => __('', 'bogidope'),
                'description' => __('Headings color', 'bogidope'),
                'priority' => 2,
                'type' => 'color',
                'section' => 'typography-settings',
...
******************************************************************/
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'button_background_hover',
            array(
                'label' => __('', 'bogidope'),
                'description' => __('Background hover', 'bogidope'),
                'priority' => 2,
                'type' => 'color',
                'section' => 'buttons-settings',
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'button_text_normal',
            array(
                'label' => __('', 'bogidope'),
                'description' => __('Text normal', 'bogidope'),
                'priority' => 3,
                'type' => 'color',
                'section' => 'buttons-settings',
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'button_text_hover',
            array(
                'label' => __('', 'bogidope'),
                'description' => __('Text hover', 'bogidope'),
                'priority' => 4,
                'type' => 'color',
                'section' => 'buttons-settings',
...
******************************************************************/
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'footer_headings_color',
            array(
                'label' => __('', 'bogidope'),
                'description' => __('Hedings color', 'bogidope'),
                'priority' => 3,
                'type' => 'color',
                'section' => 'footer-settings',
...
//facebook
    ...
    $wp_customize->add_control('facebook_url', array(
        'label' => esc_html__('Facebook url', 'bogidope'),
        'type' => 'url',
...
//twitter
    ...
    $wp_customize->add_control('twitter_url', array(
        'label' => esc_html__('Twitter url', 'bogidope'),
        'type' => 'url',
        'section' => 'social-settings',
...
//google
    ...
    $wp_customize->add_control('google_url', array(
        'label' => esc_html__('Google plus url', 'bogidope'),
        'type' => 'url',
        'section' => 'social-settings',
        'settings' => 'google_url',
    ));
//pinterest
    ...
    $wp_customize->add_control('pinterest_url', array(
        'label' => esc_html__('Pinterest url', 'bogidope'),
        'type' => 'url',
        'section' => 'social-settings',
...
//tumblr
    ...
    $wp_customize->add_control('tumblr_url', array(
        'label' => esc_html__('Tumblr url', 'bogidope'),
        'type' => 'url',
        'section' => 'social-settings',
        'settings' => 'tumblr_url',
    ));
//instagram
    ...
    $wp_customize->add_control('instagram_url', array(
        'label' => esc_html__('Instagram url', 'bogidope'),
        'type' => 'url',
        'section' => 'social-settings',
...
//linkedin
    ...
    $wp_customize->add_control('linkedin_url', array(
        'label' => esc_html__('Linkedin url', 'bogidope'),
        'type' => 'url',
        'section' => 'social-settings',
...
//dribbble
    ...
    $wp_customize->add_control('dribbble_url', array(
        'label' => esc_html__('Dribble url', 'bogidope'),
        'type' => 'url',
        'section' => 'social-settings',
...
//youtube
    ...
    $wp_customize->add_control('youtube_url', array(
        'label' => esc_html__('Youtube url', 'bogidope'),
        'type' => 'url',
        'section' => 'social-settings',
